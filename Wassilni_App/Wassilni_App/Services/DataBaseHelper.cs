    ...
    public class DatabaseHelper
    {
        ...
        public async Task<List<Ride>> GetMatchingPoolsAsync(Ride pool)
        {
           ...
           //    r.PickupDateTime.Date == pool.PickupDateTime.Date &&
             //  r.StartDate.Date==pool.StartDate.Date && 
        ...
        /*
        public async Task<List<Ride>> GetRequestsAsync()
        {

            var requests = await _firebaseClient.Child("requestRide").OnceAsync<RideRequest>();
            return requests.Select(r => new RideRequest
            {
